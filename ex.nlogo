...
breed [people person]
people-own [being_served_times dep_period PODlist start_moving_time mypod target steps goods arrticks waitticks lifeticks depticks depcost prevdepcost totaldepcost lastpod0 lastpod1 dis2target dead walkingcost servicetime]
...
to finalstats
  ...
  let ave_service_time mean [being_served_times] of people
  let min_service_time min [being_served_times] of people
  let max_service_time max [being_served_times] of people
  let std_service_time standard-deviation [being_served_times] of people
  ...
  print (word "average service times is: " ave_service_time "; min service times is: " min_service_time "; max service times is: " max_service_time "; standard deviation of service times is: " std_service_time)
...
to goPeople
  ...
  ask people [
    ...
    if depticks > 5 * 24 * 60 [
      ...
      set depcost 1000000
      if depticks = 5 * 24 * 60 + 1 [set dep_period fput depticks dep_period]
    ...
    if servicetime > serving_time [
      ...
      set dep_period fput depticks dep_period
      set depticks 0
    ...
    if ticks = 240 * 60 - 1 and dead != 1
    [
      set dep_period fput depticks dep_period
      set being_served_times (length dep_period - 1)
      ;show dep_period
      ;print(word "my deprivation period is: " length dep_period " ; my being served times is: " being_served_times " ; Standard deprivation time is: " precision (standard-deviation dep_period) 2)
    ]
