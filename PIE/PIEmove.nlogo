...
breed [people person]
people-own [move_or_not supplies_received PODlist start_moving_time mypod target steps goods arrticks waitticks lifeticks depticks depcost prevdepcost totaldepcost lastpod0 lastpod1 dis2target dead walkingcost servicetime]
...
;; print the location information of PODs and DCs
  ...
  create-people Number_of_victims [
    ...
    ifelse random 100 < 50
     [set move_or_not 0] ;not move
     [set move_or_not 1] ; move
    ifelse move_or_not = 0
...
to finalstats
  ...
  let ave_supplies_received mean [supplies_received] of people
  let min_supplies_received min [supplies_received] of people
  let max_supplies_received max [supplies_received] of people
  let std_supplies_received standard-deviation [supplies_received] of people
  print (word "average supplies: " ave_supplies_received "; min supplies: " min_supplies_received "; max supplies: " max_supplies_received "; standard deviation of supplies: " std_supplies_received)
...
to goPeople
  ...
  ask people [
    ...
    if servicetime > serving_time [
      ...
      set supplies_received supplies_received + serving_size
...
<experiments>
  <experiment name="exp1" repetitions="1" runMetricsEveryStep="false">
    ...
    <metric>sum [dead] of people</metric>
    <metric>mean [supplies_received] of people</metric>
    <metric>min [supplies_received] of people</metric>
    <metric>max [supplies_received] of people</metric>
    <metric>standard-deviation [supplies_received] of people</metric>
    ...
    <steppedValueSet variable="init-random-seed" first="21" step="2" last="29"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
