...
breed [people person]
people-own [supplies_received PODlist start_moving_time mypod target steps goods arrticks waitticks lifeticks depticks depcost prevdepcost totaldepcost lastpod0 lastpod1 dis2target dead walkingcost servicetime]
  ...
  ask people [
    ...
    ifelse depticks = 0
      ...
      ;[set depcost 0.2354 * exp(0.1129 * depticks / 60)]
       [set depcost exp(0.065 * depticks / 60) - 1]
